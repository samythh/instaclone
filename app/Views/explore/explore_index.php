...
<body>
    ...
    <main class="explore" style="margin-top: 40px;">
            ...
            <ul class="people__list">
                ...
                <?php foreach ($results as $row):
                    ...
                    <li class="people__person">
                        <a href="<?= site_url('profile/' . $usernamee) ?>">
                            <div class="photo__header">
                                <div class="people__avatar-container">
                                    <img src="<?= base_url(empty($row['profile_picture']) ? 'images/avatar.svg' : $row['profile_picture']) ?>"
                                        class="people__avatar" />
                                </div>
                                <div class="people__info">
                                    <span class="people__username"><?= esc($usernamee) ?> <img
                                            src="<?= base_url('images/verified.png') ?>" /></span>
                        ...
                        <div class="people__column">
                            <?php if ($currentUsername !== $usernamee): ?>
                                <a
                                    href="<?= site_url('profile/toggleFollow/' . $usernamee) ?>"><?= $ifFollowing ? 'Following' : 'Follow' ?></a>
                            <?php endif; ?>
                        </div>
                    </li>
                <?php endforeach; ?>
